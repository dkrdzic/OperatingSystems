...
void interrupt System:: timer(...){
	...
	if (!contextSwitchRequest && PCB::running->timeSlice!=0) PCB::running->count--;
...
if (PCB::running==0) {PCB::running=help->myPCB; PCB::running->count=1;}
...
if (contextSwitchRequest==0) { tick(); asm int 60h;}

else contextSwitchRequest=0;
